...
# Load OpenAI API key (from environment or directly for now)
openai.api_key = os.getenv("OPENAI_API_KEY") or "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"  # Replace with your key if local testing
